# Murder Board — The ACP Build As Shipped
...
Ten traditions. Each: the lens, its kill criterion, and its best shot at showing a build bet is wrong — cited to spec text where possible.

### 1.1 Jobs-to-Be-Done
**Kill criterion:** the day-1 artifact is not the job the buyer is hiring for.
...
**Kill criterion:** you built the sustaining-tech substrate and shipped it to no one; the disruptor ships the demanded job on a worse substrate first.
...
**Kill criterion:** a front-stage promise has no back-stage actor.
...
**Kill criterion:** the trust model frustrates the operator it claims to protect.
...
**Kill criterion:** value is captured at a link you deferred.
...
**Kill criterion:** you positioned at the wrong evolutionary stage and ceded the anchor.
...
**Kill criterion:** the sequencing spends the option budget on the least-uncertain thing.
...
**Kill criterion:** a governance promise has a gap an attacker or auditor drives through.
...
**Kill criterion:** the interim shape forces a painful rebuild.
...
**Kill criterion:** a platform ships with an empty side.
...
| ID | Bet | State | p | Required? | Kill criterion (one line) |
|---|---|---|---:|:--:|---|
