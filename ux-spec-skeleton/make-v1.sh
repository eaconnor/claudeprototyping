...
# ---- README.md, because that is the file people actually look for ----------------
# Without this, the first thing in the folder alphabetically is OPEN.md — a register of
# unresolved decisions — and Finder, GitHub and every code host look for README.md
# before anything else. A front door nobody finds is not a front door.
