...
evidence_basis: ‹HYPOTHESES | FINDINGS | MIXED›
evidence_basis_stated_by: ‹the author's own name — a self-assessment, not an audit›
...
roster:
  - name: "<name>"
    project_role: "<what they are doing on the team, in their own words>"
    raci:
      product: ‹R/A/C/I or blank›
      design: ‹R/A/C/I or blank›
      research: ‹R/A/C/I or blank›
      engineering: ‹R/A/C/I or blank›
  # Repeat one block per person. A cell held by the same person as R and A is legal
  # and common at small team size — it means there is no independent check on that
  # area, which is worth knowing rather than hiding.
...
accountable_owner: "<name — the project as a whole>"
research_owner: "<name — who sets up and owns the evidence layer>"
risk_function: "<name or function — legal/privacy/security co-signer, or UNASSIGNED>"
...
escalation_path: "<name — e.g. a GM or sponsor above accountable_owner>"
escalation_path_tested: ‹true | false›
...
|---|---|---|---|---|---|
| `<name>` | `<what they're doing on the team>` | `<R/A/C/I>` | `<R/A/C/I>` | `<R/A/C/I>` | `<R/A/C/I>` |
