# Prototyping with Claude Code — Quick Start for Julian

Welcome. This guide explains how to use the `/prototype` skill in Claude Code to turn ideas into working HTML prototypes.
...
- Download at [claude.ai/code](https://claude.ai/code)
- Available as: CLI, desktop app (Mac/Windows), web app, or IDE extensions (VS Code, JetBrains)
- Free to use

**Step 2: Open this project**
- In Claude Code, open the `Bethproto` folder (this project)
- The `/prototype` skill is already configured here — no separate install needed

**Step 3: Verify it's available**
- Start a conversation in Claude Code
- Type `/prototype` and hit enter
- If Claude asks what you want to prototype, you're ready
- If Claude says the skill isn't available, ask: "Can you check if the prototype skill is installed?"

**That's it.** Skills are project-level — this one lives in the Band Protocol setup. As long as you're in this folder, `/prototype` works.

**First time using Claude Code?**
- Just talk to it like a colleague: "I need to prototype a dashboard"
- Claude will guide you through the rest
- Type `/help` anytime for general Claude Code help
