...
|---|---|---|---|---|---|---|---|---|
| W-01 | 2026-09-16 | ‹you› | ‹which gate or criterion you bypassed› | ‹why — the real reason, not the defensible one› | ‹what could go wrong because of this› | ‹what you predict it will cost› | ‹filled in later — this is the column that calibrates the gates› | `PENDING` |
| W-02 | 2026-09-16 | ‹you› | intent spec | Proceeding with gate criteria that trace to no canonical document, because `INTENT_SPEC` is empty on a fresh clone | Criteria nothing can validate; `check-trace.sh` exits 5 | Criteria drift undetected | Not yet known — OPEN.md H-02 | `PENDING` |
