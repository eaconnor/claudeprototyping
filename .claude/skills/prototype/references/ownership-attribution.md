...
<div class="card">
  ...
  <div class="attribution">
    <span class="attribution-badge">85% Beth</span>
  </div>
</div>
```
...
```html
<div class="content" data-attribution="70% Beth">
  <!-- content here -->
</div>
```
...
<div class="routed-card">
  ...
  <div class="card-body">
    ...
    <p><strong>Why now:</strong> Value Ledger ships Q3 [D]</p>
    <p><strong>If you ship without it:</strong> MSPs see charges they don't trust</p>
    <div class="roi">
  ...
  <div class="attribution">
    <span class="attribution-badge">65% Beth</span>
    <span class="attribution-note">Heavy edit on tool outline</span>
  </div>
</div>
```

**Why 65%?** Beth provided the threshold concept and Unknown gap. Tool suggested the churn stat and time savings. Beth verified both stats against source docs and rewrote the consequences.
...
Ownership attribution makes the distinction visible. `0% Beth` on a strategy recommendation = substitution. `0% Beth` on a formatted bibliography = legitimate mechanical assist.

**The test:** If Beth's advisor asked "Did you write this?" — what would Beth say? The percentage should match that answer.
...
- Bradley rail cards contain ROI or recommendations
...
**This is principle #3 from Band Protocol design principles:** Attribution as X% Beth (human-centered, not tool-defensive). See memory: `feedback_band_protocol_design_principles.md`
