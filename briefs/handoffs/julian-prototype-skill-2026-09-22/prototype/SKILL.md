...
**Toolkit — bundled with this skill, no download needed.** The full method library ships in this folder:
...
- `docs/BEGINNER-GUIDE.md` — the plain-language walkthrough for a first run
- `MAINTENANCE.md` — how to keep the library honest as you extend it

All paths below are relative to this skill folder.
...
Every framework the council uses is cited, with links, in `docs/frameworks-references.md`. The matrix math and its lineage: `docs/owen-structured-planning.md`. How to extend or repair the library: `MAINTENANCE.md`.
