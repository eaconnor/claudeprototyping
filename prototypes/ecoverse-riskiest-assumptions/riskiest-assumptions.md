...
Ordered most to least risky. The `#` keeps the deck numbering from slides 5–6 so the crosswalk still works. **NEW** marks the four that were being carried without being written down. The wording below is what each assumption should now say — the history of how it changed is in the detail sections.
